# -*- coding: utf-8 -*-
"""predictive-analysis-dicoding-hanifah.ipynb
...
numeric_features = ['Price', 'Quantity', 'Month', 'Day', 'Weekday',
...
from sklearn.model_selection import train_test_split  # Impor train_test_split
...
print(f"Akurasi Testing Set: {test_acc:.4f}")
